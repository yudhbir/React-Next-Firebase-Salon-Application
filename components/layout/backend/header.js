                    ...
                    <div className="row justify-content-between align-items-center">
                      ...
                      <div className="app-utilities col-auto">
                        ...
                        <div className="app-utility-item app-user-dropdown dropdown">
                          <a className="dropdown-toggle" id="user-dropdown-toggle" data-bs-toggle="dropdown" href="#" role="button" aria-expanded="false"><img src="/assets/images/user.png" alt="user profile" onClick={() =>activate()}/></a>
                          <ul className={`dropdown-menu ${active ? ' show activate' : ''}`} aria-labelledby="user-dropdown-toggle">
